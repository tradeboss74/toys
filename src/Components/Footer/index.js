    ...
    return (
        <div>
            <div className={styles.top}>
                ...
                {/* <p className={styles.bigNomber}>8</p> */}
                <p className={styles.littleWords}>
                    <span className={styles.span}>8</span> Філіалів по всій країні
                </p>
                {/* <p className={styles.bigNomber}>3</p> */}
                <p className={styles.littleWords}>
                    <span className={styles.span}>3</span>роки на ринку
                </p>
                {/* <p className={styles.bigNomber}>121</p> */}
                <p className={styles.littleWords}>
                    <span className={styles.span}>121</span>Товарів в каталозі
                </p>
                {/* <p className={styles.bigNomber}>12721</p> */}
                <p className={styles.littleWords}>
                    <span className={styles.span}>12721</span>Покупців
                </p>
            </div>
